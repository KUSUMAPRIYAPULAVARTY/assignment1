...
\end{align}
 ...
 \end{align}
 Solving, m$_2$ yields values 0.06 and -1.52\\
 Equation of line with normal vector\vec{n} and passing through point A is given by
 \begin{align}
 \vec{n}^T(\vec{X}-A)=0
 \end{align}
  Hence,equation of line with slope 0.06 passing through \myvec{2\\3} is
  \begin{align}
  \myvec{-0.06&1}\left(\vec{X}-\myvec{2\\3}\right)=0\\
  \implies \myvec{-0.06&1}\vec{X}=2.88
  \end{align}
  Similarly,equation of line with slope -1.52 passing through \myvec{2\\3} is
  \begin{align}
  \myvec{1.52&1}\left(\vec{X}-\myvec{2\\3}\right)=0\\
  \implies \myvec{1.52&1}\vec{X}=6.04
  \end{align}
  Thus, the required line equations are
  \begin{align}
  \myvec{-0.06&1}\vec{X}=2.88 
  \end{align}
  \begin{align}
  and
  \end{align}
  \begin{align}
   \myvec{1.52&1}\vec{X}=6.04
  \end{align}
\end{document}
